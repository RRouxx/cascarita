...
window.Cascarita = (function () {
  ...
  function agregarCopyright() {
    document.querySelectorAll(".pie").forEach(pie => {
      ...
      c.innerHTML = '© 2026 RRoux · <a href="/aprende/" style="color:inherit">Aprende</a> · <a href="/acerca/" style="color:inherit">Acerca de</a> · <a href="/contacto/" style="color:inherit">Contacto</a> · <a href="/privacidad/" style="color:inherit">Privacidad</a>';
      pie.appendChild(c);
    });
  }
